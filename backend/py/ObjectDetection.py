...
# url = 'https://res.cloudinary.com/candicelin/image/upload/v1607817705/dog_kqdssb.jpg'
# url = sys.argv[1]
image_path = './uploads/detection/target.jpg'
# image_path = io.BytesIO(urllib.request.urlopen(url).read())
# image_path = 'https://res.cloudinary.com/candicelin/image/upload/v1607795113/sample.jpg'
# image_path='airliner.jpeg'
...
import cv2
# src_img = cv2.VideoCapture(url).read()
src_img = cv2.imread(image_path)
# src_img = cv2.imdecode(np.frombuffer(file.content, np.uint8), 1) 
...
cv2.imwrite('py/output/detection.png', src_img)
