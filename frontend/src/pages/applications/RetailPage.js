...
class RetailPage extends React.Component {
  ...
  render() {
    const retailVideo = 'https://res.cloudinary.com/candicelin/video/upload/v1607826967/retail_zpjeri.mp4';
    return (
      <>
        <div class = "body">
          <Navabar/>
          ...
          <div class="page">
            ...
            <center><video controls src={retailVideo} type="video/mp4" /></center><br/> 
            ...
            <center><img src={retail1}></img></center>
            <div class="description">Another fairly common application is <b>analyzing the use of shelf space to identify suboptimal configurations</b>. In addition to discovering lost space, an algorithm of this nature can suggest better item placement.</div>      
            ...
            <center><img src={retail2}></img></center>
          </div>
          <Foot/>
        </div>
