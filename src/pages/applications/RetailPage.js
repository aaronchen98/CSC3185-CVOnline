...
<script>
  VANTA.WAVES('#my-background')
        ...
        <h1>Retail</h1>
        <p>The use of computer vision in the retail sector has been one of the most important technological trends in recent years. Below, you’ll be introduced to some very common use cases. </p>
        <br/>
        ...
        <div align="center"><img src={retail1}></img></div><br/>        
        <p>Another fairly common application is <b>analyzing the use of shelf space to identify suboptimal configurations</b>. In addition to discovering lost space, an algorithm of this nature can suggest better item placement.</p>
        <br/>
